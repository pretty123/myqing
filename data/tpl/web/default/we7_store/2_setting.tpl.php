		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" name="data[name]" class="form-control" value="<?php  echo $settings['name'];?>" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">徽标图案</label>
					<div class="col-sm-8">
						<?php  echo tpl_form_field_icon('data[icon]', $settings['icon']);?>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">徽标颜色</label>
					<div class="col-sm-8">
						<?php  echo tpl_form_field_color('data[color]', $settings['color']);?>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">品牌宣传</label>
					<div class="col-sm-8">
						<?php  echo tpl_form_field_multi_image('data[pics]', $settings['pics']);?>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">单音频</label>
					<div class="col-sm-8">
						<?php  echo tpl_form_field_audio('data[audio]', $settings['audio']);?>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">多音频</label>
					<div class="col-sm-8">
						<?php  echo tpl_form_field_multi_audio('data[multiaudio]', $settings['multiaudio']);?>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" name="data[linkman]" class="form-control" value="<?php  echo $settings['linkman'];?>" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">联系电话</label>
					<div class="col-sm-8">
						<input type="text" id="phone" name="data[phone]"  class="form-control" value="<?php  echo $settings['phone'];?>">
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">所在地址</label>
					<div class="col-sm-8">
						<input type="text" id="address" name="data[detailedaddress]"  class="form-control" value="<?php  echo $settings['detailedaddress'];?>">
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">便利店介绍</label>
					<div class="col-sm-8">
						<textarea style="height:200px;" id="description" name="data[description]" class="form-control description" cols="60"><?php  echo $settings['description'];?></textarea>
					</div>
				</div>
				<div class="form-group">
